            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[95vh] overflow-hidden border border-gray-100 flex flex-col">
                            ...
                            <div className="flex items-center mt-2">
                                ...
                                {searchTerm && (
                                    <span className="ml-2 bg-white/20 text-white px-3 py-1 rounded-full text-sm font-medium">
                                        {filteredRegistrations.length} résultat{filteredRegistrations.length !== 1 ? 's' : ''}
                                    </span>
                                )}
                            </div>
                        </div>
                ...
                <div className="flex-1 overflow-hidden flex flex-col p-6">
                    {filteredRegistrations.length > 0 ? (
                        <div className="flex-1 flex flex-col min-h-0"> {/* Important: min-h-0 pour permettre le rétrécissement */}
                            <div className="flex-1 overflow-y-auto border border-gray-200 rounded-xl shadow-sm"> {/* Hauteur définie et défilement */}
                        ...
                        <div className="flex-1 flex items-center justify-center min-h-0"> {/* Même structure pour la cohérence */}
                ...
                <div className="flex justify-between items-center p-6 border-t border-gray-100 flex-shrink-0">
                    <div className="text-sm text-gray-500">
                        ...
                        {registrationList.length > 0 && ` sur ${registrationList.length}`}
                    </div>
